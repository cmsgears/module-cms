...
namespace cmsgears\cms\common\actions\content\mvideo;
...
class Assign extends \cmsgears\core\common\actions\base\ModelAction {
	...
	public function run() {
		...
		if( isset( $this->model ) ) {
			...
			$video		= File::loadFile( $content->mobileVideo, $this->fileName );

			if( $modelContentService->updateMobileVideo( $content, $video ) ) {
