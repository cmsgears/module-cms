...
class TemplateController extends \cmsgears\core\admin\controllers\base\TemplateController {
	...
	public function init() {
		...
		$this->apixBase	= 'cms/menu/template';
		...
		$this->breadcrumbs = [
			...
			'data' => [ [ 'label' => 'Menu Templates', 'url' => $this->returnUrl ], [ 'label' => 'Data' ] ],
			'attributes' => [ [ 'label' => 'Menu Templates', 'url' => $this->returnUrl ], [ 'label' => 'Attributes' ] ],
			'config' => [ [ 'label' => 'Menu Templates', 'url' => $this->returnUrl ], [ 'label' => 'Config' ] ],
			'settings' => [ [ 'label' => 'Menu Templates', 'url' => $this->returnUrl ], [ 'label' => 'Settings' ] ]
		];
	}
