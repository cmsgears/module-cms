...
/**
 * ModelFileController provides actions specific to article files.
 *
 * @since 1.0.0
 */
class ModelFileController extends \cmsgears\core\admin\controllers\base\ModelFileController {
	...
	public function init() {
		...
		$this->returnUrl = isset( $this->returnUrl ) ? $this->returnUrl : Url::toRoute( [ '/cms/article/model-file/all' ], true );
