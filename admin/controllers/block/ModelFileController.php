...
/**
 * ModelFileController provides actions specific to block files.
 *
 * @since 1.0.0
 */
class ModelFileController extends \cmsgears\core\admin\controllers\base\ModelFileController {
	...
	public function init() {
		...
		$this->apixBase	= 'cms/block/model-file';
		...
		$this->returnUrl = isset( $this->returnUrl ) ? $this->returnUrl : Url::toRoute( [ '/cms/block/model-file/all' ], true );
