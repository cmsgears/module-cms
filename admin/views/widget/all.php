...
<?= DataGrid::widget([
	...
	//'dataView' => "$moduleTemplates/grid/data/widget",
	//'cardView' => "$moduleTemplates/grid/cards/widget",
...
<?= Popup::widget([
	...
	'data' => [ 'model' => 'Widget', 'app' => 'main', 'controller' => 'crud', 'action' => 'bulk', 'url' => "cms/widget/bulk" ]
]) ?>

<?= Popup::widget([
	'title' => 'Delete Widget', 'size' => 'medium',
	'templateDir' => Yii::getAlias( "$themeTemplates/widget/popup/grid" ), 'template' => 'delete',
	'data' => [ 'model' => 'Widget', 'app' => 'main', 'controller' => 'crud', 'action' => 'delete', 'url' => "cms/widget/delete?id=" ]
]) ?>
