...
$this->title	= 'Blocks | ' . $coreProperties->getSiteTitle();
...
<?= Popup::widget([
	...
	'data' => [ 'model' => 'Element', 'app' => 'main', 'controller' => 'crud', 'action' => 'bulk', 'url' => "cms/element/bulk" ]
]) ?>

<?= Popup::widget([
	'title' => 'Delete Element', 'size' => 'medium',
	'templateDir' => Yii::getAlias( "$themeTemplates/widget/popup/grid" ), 'template' => 'delete',
	'data' => [ 'model' => 'Element', 'app' => 'main', 'controller' => 'crud', 'action' => 'delete', 'url' => "cms/element/delete?id=" ]
]) ?>
