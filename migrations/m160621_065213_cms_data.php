...
class m160621_065213_cms_data extends Migration {
	...
	private function insertSystemPages() {
		...
		$pages	= [
			...
			[ $this->site->id, $this->master->id, $this->master->id, 'OTP Reset Password', 'otp-reset-password', CmsGlobal::TYPE_PAGE, null, null, Page::STATUS_ACTIVE, Page::VISIBILITY_PUBLIC, 0, false, false, DateUtil::getDateTime(), DateUtil::getDateTime() ],
			...
			[ $this->site->id, $this->master->id, $this->master->id, 'Search Posts', 'search-posts', CmsGlobal::TYPE_PAGE, null, null, Page::STATUS_ACTIVE, Page::VISIBILITY_PUBLIC, 0, false, false, DateUtil::getDateTime(), DateUtil::getDateTime() ]
		];
		...
		$pages	= [
			...
			[ Page::findBySlugType( 'otp-reset-password', CmsGlobal::TYPE_PAGE )->id, CmsGlobal::TYPE_PAGE, null, null, null, null, $summary, $content, DateUtil::getDateTime() ],
